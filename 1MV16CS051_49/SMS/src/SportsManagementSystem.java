...
public class SportsManagementSystem extends JFrame {
	static SportsManagementSystem frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame= new SportsManagementSystem();
	...
	public SportsManagementSystem() {
		...
		JLabel smsSportsManagement = new JLabel("     SPORTS MANAGEMENT SYSTEM");
